...
export default function ForgotPassword() {
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        try {
            ...
            toast.success('Password reset link sent to your email!', { id: toastId, duration: 2000 });
    ...
    return (
        <Card className="w-full max-w-lg border-0 shadow-none bg-card md:bg-transparent">
                    ...
                    <CardContent className="space-y-4">
                        <div className="text-center space-y-3 py-4">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-4">
                                Please check your inbox and follow the instructions in the email to reset your password. The link will expire in 10 minutes.
                            </p>
                        </div>
            ...
            <CardFooter className="flex flex-col space-y-2 border-t pt-6">
                {
                    !isSuccess && <p className="text-sm text-center text-gray-700 dark:text-muted-foreground">
                        Remembered your password? <Link to={'/auth/login'} className="text-primary font-medium hover:underline">Back to login</Link>
                    </p>
                }
